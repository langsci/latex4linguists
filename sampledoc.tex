...
\begin{tikzpicture}
  \begin{axis}[
      ...
      ymin=0,
      xtick={1,2,3,4,5,6,7},
      xticklabels={CDU,GRUENE,SPD,AFD,FDP,LINKE,OTHER} 
      ]
      \addplot[ybar,black!80!black,fill=black] plot coordinates {
	  (1,30) 
      }; 
      \addplot[ybar,green!80!black,fill=green] plot coordinates {
	  (2,17) 
      }; 
      \addplot[ybar,red!80!black,fill=red] plot coordinates {
	  (3,15) 
      }; 
      \addplot[ybar,blue!80!black,fill=blue] plot coordinates {
	  (4,15) 
      }; 
      \addplot[ybar,purple!80!black,fill=purple] plot coordinates {
	  (5,10) 
      }; 
      \addplot[ybar,yellow!80!black,fill=yellow] plot coordinates {
	  (6,10) 
      }; 
      \addplot[ybar,gray!80!black,fill=gray] plot coordinates {
	  (7,3) 
      }; 
  \end{axis} 
\end{tikzpicture}  
